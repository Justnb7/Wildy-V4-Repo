...
public class VolcanicWhip extends ItemCombination {

	public VolcanicWhip(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"You combined the items and created the Volcanic Whip.");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player,"Once the volcanic mix is combined with the abyssal whip",
