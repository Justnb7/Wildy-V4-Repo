...
public class HeavyBallista extends ItemCombination {

	public HeavyBallista(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player, "You combined the items and created a HEAVY BALLISTA.");
