...
public class BlueDarkBow extends ItemCombination {
	...
	public BlueDarkBow(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"You combined the items and created the Blue dark bow.");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player,"The Blue dark bow is untradeable.", 
