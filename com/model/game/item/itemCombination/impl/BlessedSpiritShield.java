...
public class BlessedSpiritShield extends ItemCombination {
	...
	public BlessedSpiritShield(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"You combined the items and created the Blessed Spirit Shield.");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player,"Once the elixer is combined with the spirit shield",
