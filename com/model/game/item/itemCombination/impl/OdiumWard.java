...
public class OdiumWard extends ItemCombination {
	...
	public OdiumWard(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player, "You combined the items and created the Odium ward (or).");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player, "A Odium ward (or) is untradeable.",
