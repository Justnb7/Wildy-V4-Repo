...
public class DragonPickaxe extends ItemCombination {
	...
	public DragonPickaxe(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"You combined the items and created the upgraded Dragon Pickaxe.");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player,"The upgraded Dragon pickaxe is untradeable.", 
