...
public class WhiteDarkBow extends ItemCombination {
	...
	public WhiteDarkBow(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"You combined the items and created the White dark bow.");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player,"The White dark bow is untradeable.", 
