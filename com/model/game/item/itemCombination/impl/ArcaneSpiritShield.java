...
public class ArcaneSpiritShield extends ItemCombination {
	...
	public ArcaneSpiritShield(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player, "You combined the items and created the Arcane Spirit Shield.");
