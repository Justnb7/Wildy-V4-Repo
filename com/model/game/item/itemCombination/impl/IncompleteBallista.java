...
public class IncompleteBallista extends ItemCombination {

	public IncompleteBallista(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"Your items created an unstrung heavy Ballista. Next Piece: Spring");
