...
public class SteamStaff extends ItemCombination {
	...
	public SteamStaff(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"You combined the items and created the Mystic Steam Staff (or).");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player,"The Mystic Steam Staff (or) is untradeable.", 
