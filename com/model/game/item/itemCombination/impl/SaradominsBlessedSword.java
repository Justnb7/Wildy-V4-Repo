...
public class SaradominsBlessedSword extends ItemCombination {
	...
	public SaradominsBlessedSword(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player, "You combined the items and created Saradomin's blessed sword.");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player, "Saradomon's blessed sword is untradable.",
