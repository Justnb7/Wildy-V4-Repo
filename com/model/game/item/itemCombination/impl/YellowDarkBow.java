...
public class YellowDarkBow extends ItemCombination {
	...
	public YellowDarkBow(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void combine(Player player) {
		...
		SimpleDialogues.sendStatement(player,"You combined the items and created the Yellow dark bow.");
	...
	public void showDialogue(Player player) {
		SimpleDialogues.sendStatement(player,"The Yellow dark bow is untradeable.", 
