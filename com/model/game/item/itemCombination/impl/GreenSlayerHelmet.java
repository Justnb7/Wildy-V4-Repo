...
public class GreenSlayerHelmet extends ItemCombination {

	public GreenSlayerHelmet(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void showDialogue(Player player) {
		...
		if(player.getSlayerInterface().getUnlocks().entrySet().toString().contains("KALPHITE_KAT")) {
