...
public class BlackSlayerMask extends ItemCombination {

	public BlackSlayerMask(Optional<int[]> skillRequirements, Item outcome, Optional<List<Item>> revertedItems, Item[] items) {
	...
	public void showDialogue(Player player) {
		...
		if(player.getSlayerInterface().getUnlocks().entrySet().toString().contains("KING_BLACK_BONNET")) {
