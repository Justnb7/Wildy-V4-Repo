...
public class MusicTab {
	...
	public static final MusicTab[] music = {
			...
			// new MusicTab("Mausoleum" ,3392,9856,3455,9919, 156, 17016,
			// 364),//
			...
			// new MusicTab("The Mad Mole" ,1728,5120,1791,5247, 573, 18175,
			// 287),
			...
			new MusicTab("Time Out", 242, 32240, 298), new MusicTab("Time to Mine", 369, 50008, 299), new MusicTab("Tiptoe", 338, 39149, 300), new MusicTab("Title Fight", 525, 61210, 301),
			new MusicTab("Tomorrow", 105, 24153, 302), new MusicTab("Too Many Cooks...", 582, 18305, 303), new MusicTab("Trawler Minor", 51, 17056, 304), new MusicTab("Trawler", 38, 17055, 305),
			new MusicTab("Tree Spirits", 130, 17057, 306), new MusicTab("Tremble", 187, 32245, 307), new MusicTab("Tribal Background", 162, 17058, 308), new MusicTab("Tribal", 165, 17059, 309),
			new MusicTab("Tribal 2", 94, 17060, 310), new MusicTab("Trinity", 192, 17061, 311), new MusicTab("Troubled", 183, 17062, 313), new MusicTab("Twilight", 88, 29037, 314),
			new MusicTab("TzHaar!", 473, 23125, 315), new MusicTab("Undercurrent", 176, 7098, 316), new MusicTab("Underground Pass", 323, 28214, 317), new MusicTab("Underground", 179, 17063, 318),
			new MusicTab("Understanding", 131, 2166, 319), new MusicTab("Unknown Land", 3, 17066, 320), new MusicTab("Upcoming", 70, 17068, 321), new MusicTab("Venture", 75, 17069, 322),
			new MusicTab("Venture 2", 45, 26211, 323), new MusicTab("Victory is Mine", 528, 61213, 324), new MusicTab("Village", 61, 31182, 325), new MusicTab("Vision", 85, 17070, 326),
			new MusicTab("Voodoo Cult", 30, 17071, 327), new MusicTab("Voyage", 32, 17072, 328), new MusicTab("Wander", 49, 17073, 329), new MusicTab("Warrior", 295, 39129, 330),
			new MusicTab("Waterfall", 82, 17074, 331), new MusicTab("Waterlogged", 244, 31204, 332), new MusicTab("Wayward", 394, 52042, 333), new MusicTab("Well Of Voyage", 271, 33118, 334),
			new MusicTab("Wilderness", 435, 53145, 336), new MusicTab("Wilderness 2", 42, 17075, 337), new MusicTab("Wilderness 3", 43, 17076, 338), new MusicTab("Wild Side", 475, 56118, 335),
			new MusicTab("Wildwood", 8, 27071, 339), new MusicTab("Witching", 14, 17078, 340), new MusicTab("Woe of the Wyvern", 529, 61214, 341), new MusicTab("Wolf Mountain", 422, 26186, 342),
			new MusicTab("Wonder", 34, 17079, 343), new MusicTab("Wonderous", 81, 17080, 344), new MusicTab("Woodland", 255, 33123, 345),
			new MusicTab("Workshop", 15, 17081, 346),
			new MusicTab("Wrath and Ruin", 565, 58233, 375),//
			new MusicTab("Xenophobe", 524, 59242, 347), new MusicTab("Yesteryear", 145, 23101, 348), new MusicTab("Zealot", 146, 7106, 349), new MusicTab("Zogre Dance", 392, 52043, 350),
	...
	static {
		ActionButtonEventListener.submit(new ActionButtonEvent() {
			...
			public List<ActionButton> getButtons() {
				...
				for (MusicTab tab : music) {
					buttons.add(new ActionButton(tab.buttonId, this));
				}
				buttons.add(new ActionButton(24125, this));
				buttons.add(new ActionButton(24126, this));
				buttons.add(new ActionButton(38197, this));
				return buttons;
			}
			...
			public void onActionButtonClick(Player player, ActionButton button) {
				switch (button.getId()) {
				case 24125: // AUTO
					player.setAttribute("AUTO_MUSIC_DISABLED", Boolean.FALSE);
