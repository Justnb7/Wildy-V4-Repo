...
public class FarmingHerb {
	...
	public enum Herb {
		...
		GUAM(5291, 199, 100, 30, 1, 25), MARRENTIL(5292, 201, 200, 50, 7, 25), TARROMIN(5293, 203, 300, 100, 19, 25), HARRALANDER(5294, 205, 500, 150, 26, 25), RANARR(5295, 207, 600, 200, 32, 50), TOADFLAX(5296, 3049, 1000, 250, 38, 50), IRIT(5297, 209, 1250, 300, 44, 50), AVANTOE(5298, 211, 1500, 350, 50, 50), KWUARM(5299, 213, 1750, 375, 56, 50), SNAP_DRAGON(5300, 3051, 2000, 400, 62, 100), CADANTINE(5301, 215, 2250, 425, 67, 100), LANTADYME(5302, 2485, 2300, 450, 73, 100), DRAWF_WEED(5303, 217, 2400, 475, 79, 100), TORSTOL(5304, 219, 2500, 500, 85, 100);
		...
		public String getSeedName() {
			return getItemName(seedId);
		}

		public String getGrimyName() {
			return getItemName(grimyId);
		}
	}
