...
public class SkillInterfaces {
	...
	private void optionTab(String title, String currentTab, String op1,
		...
		c.write(new SendInterfacePacket(8714));
	...
	public void attackComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().ATTACK], 0);
	...
	public void strengthComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().STRENGTH], 0);
	...
	public void defenceComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().DEFENCE], 0);// Skill
																	// mastery
	...
	public void rangedComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().RANGE], 1);
	...
	public void prayerComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().PRAYER], 1);
	...
	public void magicComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().MAGIC], 1);
	...
	public void runecraftingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().RUNECRAFTING], 0);
	...
	public void hitpointsComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().HITPOINTS], 0);
	...
	public void agilityComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().AGILITY], 1);
	...
	public void herbloreComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().HERBLORE], 0);
	...
	public void thievingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill mastery",
					Shop.skillCapes[c.getSkills().THIEVING], 0);
	...
	public void craftingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().CRAFTING], 1);
	...
	public void fletchingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().FLETCHING], 0);
	...
	public void slayerComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().SLAYER], 0);
	...
	public void smithingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().SMITHING], 0);
	...
	public void fishingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().FISHING], 1);
	...
	public void cookingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().COOKING], 1);
	...
	public void firemakingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().FIREMAKING], 0);
	...
	public void woodcuttingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().WOODCUTTING], 0);
	...
	public void farmingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					Shop.skillCapes[c.getSkills().FARMING], 0);
