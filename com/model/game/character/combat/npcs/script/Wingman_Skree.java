...
public class Wingman_Skree extends AbstractBossCombat {
	...
	public void execute(Entity attacker, Entity victim) {
		...
		case MAGIC:
			...
			randomHit = Utility.random(maxHit);
				...
				attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1192, 45, 50, speedEquation, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
				Hit  hitInfo = victim.take_hit(attacker, randomHit, CombatStyle.MAGIC, false);
				Combat.hitEvent(attacker, victim, 4, hitInfo, CombatStyle.MAGIC);
			break;
		default:
			break;
