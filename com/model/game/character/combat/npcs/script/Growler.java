...
public class Growler extends AbstractBossCombat {
	...
	public void execute(Entity attacker, Entity victim) {
		...
		case MAGIC:
			...
			attacker.playGraphics(Graphic.create(1182));
			randomHit = Utility.random(maxHit);
				...
				attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1183, 45, 50, speedEquation, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
